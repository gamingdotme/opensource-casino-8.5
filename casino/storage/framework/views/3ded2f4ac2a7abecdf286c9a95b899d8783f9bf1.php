                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div type="main-slider" class="ng-binding ng-scope ng-isolate-scope">
                                            <div class="main-slider__promo active">
                                                ...
                                                <div class="main-slider__promo-wrp">
                                                    <p class="main-slider__promo-txt"><?php echo app('translator')->get('app.welcome_package'); ?>
                                                        ...
                                                        <br> <span class="main-slider__promo-bg"><span class="text-color-blue">+ 200</span> <?php echo app('translator')->get('app.free_spins'); ?></span>
                                                    </p>
                                            ...
                                            <div class="main-slider__promo">
                                                <a class="main-slider__link" href=""></a>
                                                <div class="main-slider__promo-wrp">
                                                    <p class="main-slider__promo-txt"><?php echo app('translator')->get('app.daily'); ?> <?php echo app('translator')->get('app.slot_race'); ?>
                                                        <br> <span class="main-slider__promo-separator">
                                                            €/$ &nbsp; <span class="text-color-yellow"> 800 &nbsp;</span></span>
                                                        <br> <span class="main-slider__promo-bg">
                                                            <span class="text-color-blue">+ 800 </span> <?php echo app('translator')->get('app.free_spin_every_day'); ?>! </span>
                                                    </p>
                                                    <div class="main-slider__btn-wrp ng-isolate-scope">
                                                        <!-- ngIf: !$root.data.user.email -->
                                            ...
                                            <div class="main-slider__promo">
                                                <a class="main-slider__link" href=""></a>
                                                <div class="main-slider__promo-wrp">
                                                    <p class="main-slider__promo-txt"><?php echo app('translator')->get('app.complete_all_missions'); ?>
                                                        <br> <span class="main-slider__promo-separator"><span class="text-color-yellow"><?php echo app('translator')->get('app.and'); ?> <?php echo app('translator')->get('app.get_more_than'); ?> <br>$/€150,000 in <?php echo app('translator')->get('app.rewards'); ?></span> </span>
                                                    </p>
                                                    <div class="main-slider__btn-wrp ng-isolate-scope">
                                                        <!-- ngIf: !$root.data.user.email -->
                        ...
                        <nav class="category-panel__menu games-menu ng-isolate-scope" name="games_menu">
                            <ul class="games-menu__list">
                                <li class="games-menu__item games-menu__item--bitcoin">
                                    <a class="games-menu__link games-menu__link--bitcoin" href="<?php echo e(route('frontend.game.list.category', 'all')); ?>"> <i class="games-menu-icon games-menu-icon--bitcoin"></i> <span class="games-menu__title ng-scope"><?php echo app('translator')->get('app.all'); ?></span> </a>
                                </li>

                                <li class="games-menu__item games-menu__item--woo_choice">
                                    <a class="games-menu__link games-menu__link--woo_choice" href="<?php echo e(route('frontend.game.list.category', 'hot')); ?>"> <i class="games-menu-icon games-menu-icon--woo_choice"></i> <span class="games-menu__title ng-scope" ><?php echo app('translator')->get('app.hot_game'); ?></span> </a>
                                </li>
                                ...
                                <li class="games-menu__item games-menu__item--new-games">
                                    <a class="games-menu__link games-menu__link--new-games" href="<?php echo e(route('frontend.game.list.category', 'new')); ?>"> <i class="games-menu-icon games-menu-icon--new-games"></i> <span class="games-menu__title ng-scope" ><?php echo app('translator')->get('app.new'); ?></span> </a>
                                </li>
                                <!-- end ngRepeat: filter_collection in gamesData.data.collections | limitTo: 9 -->
                                <li class="games-menu__item games-menu__item--slots">
                                    <a class="games-menu__link games-menu__link--slots" href="<?php echo e(route('frontend.game.list.category', 'slots')); ?>"> <i class="games-menu-icon games-menu-icon--slots"></i> <span class="games-menu__title ng-scope" ><?php echo app('translator')->get('app.slots'); ?></span> </a>
                                </li>
                                <!-- end ngRepeat: filter_collection in gamesData.data.collections | limitTo: 9 -->
                                <li class="games-menu__item games-menu__item--bonus_buy_slots">
                                    <a class="games-menu__link games-menu__link--bonus_buy_slots" href="<?php echo e(route('frontend.game.list.category', 'jackpot')); ?>"> <i class="games-menu-icon games-menu-icon--bonus_buy_slots"></i> <span class="games-menu__title ng-scope" >Jackpot</span> </a>
                                </li>
                                <li class="games-menu__item games-menu__item--roulette-games">
                                    <a class="games-menu__link games-menu__link--roulette-games" href="<?php echo e(route('frontend.game.list.category', 'roulette')); ?>"> <i class="games-menu-icon games-menu-icon--roulette-games"></i> <span class="games-menu__title ng-scope" >Roulette</span> </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                                ...
                                <li class="providers__item ng-scope">
                                    <a class="providers__link" scroll-up="" href="<?php echo e(route('frontend.game.list.category', $v)); ?>">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--<?php echo e($v); ?>" alt="<?php echo e($v); ?>" src="/frontend/Default/svg/<?php echo e($v); ?>.svg">
                                        </span>
                            ...
                            <?php if($categories && count($categories)): ?>
                                ...
                                <li class="providers__dropdown-item ng-scope">
                                    <a class="providers__link" href="<?php echo e(route('frontend.game.list.category', $category->href)); ?>">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--1x2gaming" alt="" src="/frontend/Default/svg/<?php echo e($category->href); ?>.svg">
                                        </span>
...
<?php echo $__env->make('frontend.Default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/betshopus/casino/resources/views/frontend/Default/games/list.blade.php ENDPATH**/ ?>