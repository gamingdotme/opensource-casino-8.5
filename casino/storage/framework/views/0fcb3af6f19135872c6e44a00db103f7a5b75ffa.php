...
<iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;" src='/games/KeksIG/index.html?curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>&lang=en' allowfullscreen>
...
<?php /**PATH /home/betshopus/casino/resources/views/frontend/games/list/KeksIG.blade.php ENDPATH**/ ?>